...
class ModelCardiotocography(MyClassifier, Chain):
    def __init__(self, prior, dim):
        super(ModelCardiotocography, self).__init__(l1=L.Linear(dim, 20, nobias=True),
                                                    b1=L.BatchNormalization(20),
                                                    l2=L.Linear(20, 15, nobias=True),
                                                    b2=L.BatchNormalization(15),
                                                    l3=L.Linear(15, 5, nobias=True),
                                                    b3=L.BatchNormalization(5),
                                                    l4=L.Linear(5, 1))
        self.af = F.relu
        self.prior = prior
...
class ModelFAHZU(MyClassifier, Chain):
    def __init__(self, prior, dim):
        super(ModelFAHZU, self).__init__(l1=L.Linear(dim, 200, nobias=True),
                                         b1=L.BatchNormalization(200),
                                         l2=L.Linear(200, 150, nobias=True),
                                         b2=L.BatchNormalization(150),
                                         l3=L.Linear(150, 30, nobias=True),
                                         b3=L.BatchNormalization(30),
                                         l4=L.Linear(30, 1))
        self.af = F.relu
        self.prior = prior
...
class ModelMIMIC(MyClassifier, Chain):
    def __init__(self, prior, dim):
        super(ModelMIMIC, self).__init__(l1=L.Linear(dim, 200, nobias=True),
                                         b1=L.BatchNormalization(200),
                                         l2=L.Linear(200, 50, nobias=True),
                                         b2=L.BatchNormalization(50),
                                         l3=L.Linear(50, 30, nobias=True),
                                         b3=L.BatchNormalization(30),
                                         l4=L.Linear(30, 1))
        self.af = F.relu
        self.prior = prior
